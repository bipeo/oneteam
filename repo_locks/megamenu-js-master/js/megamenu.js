/*global $ */
   ...
   // $(".menu > ul").before("<a href=\"#\" class=\"menu-mobile\">Navigation</a>");
    ...
    $(".menu > ul > li").hover(function (e) {
        if ($(window).width() > 767) {
          //  $(this).children("ul").stop(true, false).fadeToggle(150);
             $(".menu > ul  li").not($(this)).find('ul').stop(true,true).fadeOut(150);
    ...
    $(".navbar-toggle").click(function (e) {
       //  $("html").toggleClass("nscrl");
         //$("html").toggleClass('hid');
        $('.menu-container.navbar--top .navbar-collapse').toggleClass('in');
