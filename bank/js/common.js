...
function check_if_in_view(e) {
  ...
  var block_2_top_position = $('.block_2').position().top;
  var block_3_top_position = $('.block_3').position().top;
  var block_4_top_position = $('.block_4_bg').position().top;
  ...
  if (block_4_top_position + block_3_top_position < window_top_position - 200 && !run_animate) {
      if ($(".wr-bg-3").css('opacity') == 1) {
          return;
      }
      run_animate = true;
      $(".wr-bg-1").animate({opacity: 0}, 600, function () {
          run_animate = false;
      });
      $(".wr-bg-2").animate({opacity: 0}, 600, function () {
          run_animate = false;
      });
      $(".wr-bg-3").animate({opacity: 1}, 600, function () {
          run_animate = false;
      })
  }
      ...
      $( ".wr-bg-2" ).animate({opacity: 1}, 600, function(){
          run_animate = false;
      });
      $( ".wr-bg-3" ).animate({opacity: 0}, 600, function(){
          run_animate = false;
      });
  }
  else if (!run_animate) {
      if ($(".wr-bg-1").css('opacity') == 1) {
          return;
      }
      run_animate = true;
      $( ".wr-bg-1" ).animate({opacity: 1}, 600, function(){
          run_animate = false;
      });
      $( ".wr-bg-2" ).animate({opacity: 0}, 600, function(){
          run_animate = false;
